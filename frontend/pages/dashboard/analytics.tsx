...
const Analytics: React.FC = () => {
  const {data: analytics, refetch, isFetching: isRefetchingMyUsage} = useClientAnalyticsRetrieve();
  return (
    <div style={{height: '100%'}}>
    <Card style={{height: '50vh'}} shadow="sm" padding="lg" radius="md" withBorder>
        <Title align='center' mb='lg' order={2}>My usage of other APIs - last 14 days</Title>
      ...
      <Card style={{height: '50vh'}}  mt='lg' shadow="sm" padding="lg" radius="md" withBorder>
        <Title align='center' mb='lg' order={2}>Other's usage of my APIs - last 14 days</Title>
